...
QUnit.skip('Services List is correctly rendered', function(){
	renderTemplate({
...
QUnit.skip('Services can be edited', function(){
	renderTemplate({
		services : new can.List(services),
		currentService : new can.compute(),
		state : new can.Map({
...
QUnit.skip('Services can have no results', function(){
	var servicesList = new can.List(services);
...
QUnit.skip('Services can have be in error state', function(){
	var servicesList = new can.List(services);
